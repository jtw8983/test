...
commands = [
  ...
  {"command":"user_add", "arguments": ["name","email","password","gender","del_yn"], "method": user_add },
  ...
  {"command":"board_add", "arguments":["title","content","del_yn","user_no"], "method": board_add},
  {"command":"board_detail", "arguments":["no"], "method": board_detail},
  {"command":"board_edit", "arguments":["no","content"], "method": board_edit},
